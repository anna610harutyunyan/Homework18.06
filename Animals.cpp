...
public:
	...
	virtual void voice()
	{
		std::cout << "Voice of animals  \n";
	}

	virtual void movement()
	{
		std::cout << "Types of animal's movements  \n";
	}
	 virtual ~Animal()
	{
		delete [] array;
...
public:
	...
	virtual void voice()
	{
		std::cout << "This kind of animals have low voices \n";
	}
	virtual void movement()
	{
		std::cout << "Type of movement is swimming \n";
	}
...
public:
	...
	void voice() override
	{
		std::cout << "Voices can be very loud \n";
	}
	void movement()override
	{
		std::cout << "This kind of animals can walke and run, jump (saltation), and crawl \n";
	}
...
public:
	...
	void voice() override
	{
		std::cout << "Some of them have beautifule voices  \n  ";
	}
	void movement() override
	{
		std::cout << "Birds are flying  \n";
	}
	virtual ~Birds()
	{
		delete[] array;
